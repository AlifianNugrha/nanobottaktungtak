      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Button
            ...
            className="h-10 rounded-xl px-5 text-xs font-bold bg-orange-600 text-white shadow-lg shadow-orange-600/20"
          >
        ...
        {['All', 'Unread', 'Sales', 'System', 'AI Bot'].map((tab) => (
          ...
          >
            ...
            {tab === 'Unread' && notifications.filter(n => n.unread).length > 0 && (
              <span className="ml-2 bg-orange-600 text-white px-1.5 py-0.5 rounded-md text-[9px]">
            ...
            >
              <div className="flex items-stretch min-h-[85px]">
                ...
                <div className={`w-1 ${!n.unread ? 'bg-gray-200' :
                  n.type === 'Sales' ? 'bg-green-500' : 'bg-orange-600'
                  }`} />
                ...
                <div className="flex-1 p-5 flex items-center gap-5">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                      <span className={`text-[9px] font-black uppercase tracking-widest ${n.unread ? 'text-orange-600' : 'text-muted-foreground'}`}>
                        {n.type}
                      </span>
                  ...
                  {/* Titik Unread */}
                  {n.unread && <div className="w-2 h-2 rounded-full bg-orange-600 animate-pulse" />}
