    ...
    <div className="max-w-6xl mx-auto w-full space-y-8 px-4 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border pb-6">
        ...
        <div className="flex gap-3">
          ...
          <Button className="bg-orange-600 text-white rounded-xl gap-2 font-bold h-11 px-6 shadow-lg shadow-orange-600/20">
              ...
              <tbody className="divide-y divide-border">
                {filteredSales.map((sale) => (
                  <tr key={sale.id} className="hover:bg-gray-50/50 transition-colors group text-sm">
                    <td className="px-6 py-4 font-mono font-medium text-xs text-orange-600">{sale.id}</td>
