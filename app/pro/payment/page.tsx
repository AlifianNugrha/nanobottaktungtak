  ...
  return (
    <div className="max-w-6xl mx-auto w-full space-y-8 px-4 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border pb-6">
        ...
        {view === 'main' && (
          <div className="flex items-center gap-3 bg-orange-600/5 px-4 py-2 rounded-2xl border border-orange-600/10">
            <div className="flex flex-col items-end">
              <span className="text-[10px] font-bold text-orange-600 uppercase">AI Closing Mode</span>
      ...
      {view === 'main' ? (
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
          ...
          <Card className="p-1 border-orange-600/20 bg-gradient-to-br from-orange-600/5 via-white to-white overflow-hidden shadow-sm">
            <div className="p-8 flex flex-col md:flex-row items-center gap-8 relative z-10">
              <div className="w-16 h-16 bg-orange-600 rounded-2xl flex items-center justify-center text-white shadow-xl shadow-orange-600/30 shrink-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="flex items-center justify-between">
                <h3 className="font-bold text-lg flex items-center gap-2">
                  <Wallet className="w-5 h-5 text-orange-600" /> Connected Gateways
                </h3>
              </div>

              <Card className="p-6 border-border group hover:border-orange-600/50 transition-all">
                ...
                <Button onClick={() => setIsConfigOpen(true)} variant="outline" className="w-full mt-6 rounded-xl h-10 text-xs font-bold gap-2 group-hover:bg-orange-600 group-hover:text-white transition-all">
            ...
            <div className="space-y-6">
              <h3 className="font-bold text-lg flex items-center gap-2">
                <CircleDollarSign className="w-5 h-5 text-orange-600" /> Settlements
              </h3>
              <Card className="p-6 space-y-4 border-border shadow-sm bg-white">
                ...
                <Button variant="ghost" className="w-full text-xs font-bold text-orange-600 h-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in slide-in-from-right-4 duration-500">
          <div className="space-y-6">
            <Card className="p-6 bg-orange-600 text-white space-y-4 rounded-[2.5rem] border-none shadow-xl shadow-orange-600/20">
          ...
          <div className="lg:col-span-2">
            <Card className="p-8 space-y-8 shadow-sm">
              <div className="space-y-6">
                <div className="space-y-3">
                  <Label className="text-xs font-bold uppercase flex items-center gap-2">
                    <Target className="w-4 h-4 text-orange-600" /> Trigger Keywords
                  </Label>
                  <Input
                ...
                <div className="space-y-3">
                  <Label className="text-xs font-bold uppercase flex items-center gap-2">
                    <MessageSquare className="w-4 h-4 text-orange-600" /> Bot Closing Message
                  </Label>
                  <Textarea
              ...
              <div className="flex gap-4 pt-6 border-t border-border">
                <Button onClick={handleSaveLogic} disabled={isSaving} className="flex-1 h-12 bg-orange-600 text-white font-bold rounded-xl shadow-lg shadow-orange-600/20">
        ...
        <DialogContent className="sm:max-w-[500px] rounded-[2.5rem] p-8 border-none shadow-2xl">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold flex items-center gap-3">
              <Key className="w-6 h-6 text-orange-600" /> Midtrans Keys
            </DialogTitle>
          ...
          <div className="space-y-5 py-4">
            ...
            <div className="p-4 bg-orange-600/5 rounded-2xl border border-orange-600/10 space-y-2 text-center">
              <Label className="text-[10px] font-black text-orange-600 uppercase">Webhook Notification URL</Label>
              <div className="flex gap-2 justify-center items-center bg-white p-2 rounded-lg border border-orange-600/10">
                <code className="text-[10px] font-mono truncate max-w-[200px]">https://api.nexora.ai/hooks/midtrans</code>
                <Button size="icon" variant="ghost" className="h-7 w-7 text-orange-600" onClick={copyWebhook}>
          ...
          <DialogFooter className="sm:justify-start gap-3">
            <Button onClick={() => setIsConfigOpen(false)} className="flex-1 bg-orange-600 text-white font-bold h-12 rounded-xl shadow-lg shadow-orange-600/20">
              Save & Connect
            </Button>
          </DialogFooter>
        </DialogContent>
