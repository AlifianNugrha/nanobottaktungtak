  ...
  return (
    <div className="max-w-6xl mx-auto w-full space-y-8 px-4 pb-20">
      ...
      <div className="flex items-center justify-between border-b border-border pb-6">
        ...
        {view === 'list' && (
          <Button onClick={() => { setFormData({ id: '', name: '', email: '', phone: '', status: 'Lead' }); setView('add'); }} className="bg-orange-600 hover:bg-orange-700 text-white gap-2 h-11 px-6 font-bold shadow-lg shadow-orange-600/20 rounded-xl">
                    ...
                    <tr key={c.id} className="hover:bg-gray-50/50 transition-colors group">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center font-bold text-orange-600 border border-border">
                            {c.name.charAt(0)}
                          </div>
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                          <Button variant="ghost" size="icon" onClick={() => { setFormData(c); setView('edit'); }} className="h-8 w-8 text-muted-foreground hover:text-orange-600">
        ...
        <div className="max-w-2xl mx-auto animate-in slide-in-from-bottom-4 duration-500">
          <Card className="p-8 space-y-6 shadow-sm border-border">
            ...
            <div className="flex gap-4 pt-4 border-t border-border">
              <Button onClick={handleSave} disabled={isSaving} className="flex-1 h-12 bg-orange-600 text-white font-bold rounded-xl shadow-lg shadow-orange-600/20">
