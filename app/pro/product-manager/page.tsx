      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border pb-6">
        ...
        {view === 'list' && (
          <div className="flex gap-3">
                ...
                <div className="space-y-4 mt-4">
                  <div className="flex gap-2">
                    <Input
                      ...
                      // This one is tricky due to indentation context not fully visible but based on surrounding lines:
                      // onKeyDown={(e) => e.key === 'Enter' && handleAddCategory()}
                      // />
                      // <Button onClick={handleAddCategory} className="bg-orange-600 text-white h-11 px-4 rounded-xl">
                  ...
                  <div className="space-y-2 max-h-[250px] overflow-y-auto pr-2">
                    {categories.map(cat => (
                      <div key={cat} className="flex items-center justify-between p-3 bg-gray-50 rounded-xl border border-transparent hover:border-orange-600/20 transition-all">
            ...
            <Button onClick={() => setView('add')} className="bg-orange-600 hover:bg-orange-700 text-white gap-2 h-11 px-6 font-bold shadow-lg shadow-orange-600/20 rounded-xl">
      ...
      {view === 'list' ? (
              ...
              <Card key={product.id} className="group overflow-hidden border-border bg-white hover:shadow-xl transition-all">
                ...
                <div className="p-5">
                  <div className="flex justify-between items-start mb-1">
                    ...
                    <p className="font-bold text-orange-600">Rp {product.price}</p>
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t">
                    ...
                    <div className="flex gap-1">
                      <Button variant="ghost" size="icon" onClick={() => { setFormData(product); setView('edit'); }} className="h-8 w-8 rounded-lg hover:bg-orange-600/10 hover:text-orange-600">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in slide-in-from-bottom-4 duration-500">
          <Card className="p-6 text-center space-y-4 shadow-sm h-fit">
            ...
            <div className="aspect-square w-full max-w-[200px] mx-auto border-2 border-dashed border-orange-600/20 rounded-[2rem] flex flex-col items-center justify-center bg-gray-50 hover:bg-orange-600/5 transition-all cursor-pointer group">
              <Upload className="w-6 h-6 text-muted-foreground group-hover:text-orange-600" />
              <span className="text-[10px] font-bold mt-2 text-muted-foreground group-hover:text-orange-600 uppercase">Upload</span>
            </div>
          </Card>
          ...
          <div className="lg:col-span-2">
            <Card className="p-8 space-y-6 shadow-sm">
              ...
              <div className="flex gap-4 pt-4 border-t">
                <Button onClick={handleSaveProduct} disabled={isSaving} className="flex-1 h-12 bg-orange-600 text-white font-bold rounded-xl shadow-lg shadow-orange-600/20">
