...
export default function BotBuilderPage() {
  ...
  const handleAddBot = async () => {
    ...
    const platformIcons: any = {
      ...
      'Web Chat': { icon: Globe, color: 'text-orange-600' }
    };
  ...
  return (
    <div className="max-w-5xl mx-auto w-full space-y-8 px-4 pb-20 animate-in fade-in duration-500">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        {view === 'list' ? (
          <Button onClick={() => setView('add')} className="bg-orange-600 hover:bg-orange-700 text-white gap-2 h-11 px-6 font-bold shadow-lg shadow-orange-600/20">
      ...
      {view === 'list' ? (
        ...
        <div className="grid grid-cols-1 gap-4">
          {bots.length > 0 ? (
            bots.map((bot) => (
              <Card key={bot.id} className="p-4 border-border bg-white hover:border-orange-600/30 transition-all group">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button variant="ghost" size="icon" className="text-muted-foreground hover:text-orange-600 rounded-xl">
          ...
          <Card className="p-8 space-y-8 bg-white border-border shadow-2xl shadow-black/[0.02] rounded-[2rem]">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="h-12 rounded-xl bg-gray-50 border-border focus:ring-orange-600/20"
                />
              </div>
            ...
            <div className="flex gap-3 pt-4">
              <Button
                ...
                disabled={isSaving}
                className="flex-1 h-12 bg-orange-600 text-white font-bold rounded-xl shadow-lg shadow-orange-600/20 transition-all active:scale-95"
              >
